  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-gradient-hero text-primary-foreground lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <div className="relative text-xs text-white/50">© 2026 · Todos los derechos reservados.</div>
      </div>
      <div className="flex flex-col bg-background">
        <div className="flex justify-end p-6 lg:hidden">
          <Link to="/" aria-label="Skill-to-Money inicio">
            <img src="/brand/skill-to-money-logo-white.png" alt="Skill-to-Money" className="h-auto w-[150px] rounded-xl bg-[#020608] p-2 object-contain" />
          </Link>
        </div>
